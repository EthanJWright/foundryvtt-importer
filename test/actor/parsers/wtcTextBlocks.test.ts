...
import { featTypeGuard } from '../../../src/module/item/interfaces';
...
describe('getAllFeatures', () => {
  ...
  it('should parse uses per day properly from spells', () => {
    const text =
      "Medium Humanoid (Aarakocra), Typically Neutral Good\nArmor Class 13\nHit Points 84 (13d8 + 26)\nSpeed 20 ft., fly 50 ft.\nSTR DEX CON INT WIS CHA\n10 (+0) 16 (+3) 14 (+2) 11 (+0) 17 (+3) 11 (+0)\nSkills Nature +6, Perception +9, Stealth +9, Survival +9\nSenses passive Perception 19\nLanguages Aarakocra, Auran\nChallenge 5 (1,800 XP) Proficiency Bonus +3\nDive Attack. If the aarakocra is flying and dives at least 30 feet\nstraight toward a target and then hits it with a melee weapon attack,\nthe attack deals an extra 7 (2d6) damage to the target.\nActions\nMultiattack. The aarakocra makes two Talon attacks or uses Lancing\nWind twice.\nTalon. Melee Weapon Attack: +6 to hit, reach 5 ft., one target.\nHit: 5 (1d4 + 3) slashing damage plus 4 (1d8) lightning damage.\nLancing Wind. Ranged Spell Attack: +6 to hit, range 120 ft., one\ntarget. Hit: 12 (2d8 + 3) force damage. If the target is a Large or\nsmaller creature, it must succeed on a DC 14 Strength saving throw\nor be knocked prone.\nSpellcasting. The aarakocra casts one of the following spells using\nWisdom as the spellcasting ability (spell save DC 14, +6 to hit with\nspell attacks):\nAt will: light, guidance, thaumaturgy, word of radiance\n2/day each: cure wounds, call lightning\n1/day each: beacon of hope, conjure elemental (air), freedom of\nmovement, ice storm\nBonus Actions\nFury of Syranita (3/Day). The aarakocra causes its melee or ranged\nweapon attacks to magically deal an extra 7 (2d6) lightning or\nthunder damage to a target on a hit. This benefit lasts until the end of\nthe turn.\nLegendary Actions\nThe aarakocra can take 3 legendary actions, choosing from the\noptions below. Only one legendary action option can be used at a time\nand only at the end of another creature's turn. The aarakocra regains\nspent legendary actions at the start of its turn.\nAttack. The aarakocra makes a Talon attack or uses Lancing Wind.\nCast a Spell (Costs 2 Actions). The aarakocra uses Spellcasting.\nWings of Syranita (Costs 2 Actions). The aarakocra beats its wings\nand summons friendly winds from Syranita. Each enemy creature\nwithin 20 feet of the aarakocra must succeed on a DC 14 Dexterity\nsaving throw or take 13 (3d8) bludgeoning damage, pushed up\nto 10 feet away from the aarakocra, and be knocked prone. On a\nsuccessful save, a creature takes half as much damage and isn't\npushed or knocked prone.";
    const actor = textToActor(text);
    const fury = actor.items.find((i) => i.name === 'Fury of Syranita (3/Day)');
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    expect((fury as any).uses.per).toEqual('day');
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    expect((fury as any).uses.value).toEqual(3);
  });
});
